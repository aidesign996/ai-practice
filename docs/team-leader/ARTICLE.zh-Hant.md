...
**我的日常用法很簡單：先讓它接手，再把想法交代給它。** 在已經安裝並能識別這個 Skill 的工具中，打開項目對話，選擇 Team Leader，或在消息裡寫上 `$team-leader`。項目已經有資料時，讓它先了解現狀；新項目則先說你想做什麼。

### 第一句話：這個項目由你負責

我在幾個實際項目中，開場說的就是“我想讓你來接手這個項目”，或“你先了解下這個項目情況，然後說說你的看法”。下面是一種可以直接使用的說法：

> $team-leader 接下來這個項目由你負責。你先了解一下項目現在的情況，再跟我說說你的看法和下一步怎麼安排。
