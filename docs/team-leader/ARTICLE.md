...
![图8：Team Leader Skill 开发负责人通过沟通和观察，了解使用方反馈与实际工作；两类资料来自使用这套Skill的项目负责人。](technical-zh-08.png)
...
![图9：用户定目标把方向，开发负责人组织开发修订、安装更新、读取使用；从使用中观察验证、收集反馈，再返回开发修订。](technical-zh-09.png)
